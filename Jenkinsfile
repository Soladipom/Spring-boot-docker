    ...
    stage(" Maven Clean Package"){
     ...
     stage('deploy to ECR') {
       withAWS(credentials: 'moladipoawscred', region: 'us-east-1'){
           ...
           sh 'docker tag springbootapp:latest 516207934632.dkr.ecr.us-east-1.amazonaws.com/springbootapp:2'
           sh 'docker push 516207934632.dkr.ecr.us-east-1.amazonaws.com/springbootapp:2'
       }
     }
